 ...
 * 
 */
@WebServiceClient(name = "WebServiceImplService", targetNamespace = "http://webservice.xcbase.bmsoft.com.cn/", wsdlLocation = "http://222.143.158.85:8080/xcbase-webservice/share/dataList/30030")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICEIMPLSERVICE_QNAME = new QName("http://webservice.xcbase.bmsoft.com.cn/", "WebServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://222.143.158.85:8080/xcbase-webservice/share/dataList/30030");
    ...
    public IWebService getWebServiceImplPort() {
        return super.getPort(new QName("http://webservice.xcbase.bmsoft.com.cn/", "WebServiceImplPort"), IWebService.class);
    }
    ...
    public IWebService getWebServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.xcbase.bmsoft.com.cn/", "WebServiceImplPort"), IWebService.class, features);
    }
