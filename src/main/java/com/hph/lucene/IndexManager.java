...
public class IndexManager {
	...
	private static String INDEX_DIR = "C:/11/luceneIndex";
	private static String DATA_DIR = "C:/11/luceneData";
	...
	public static boolean createIndex(String path) {
		...
		for (File file : fileList) {
			...
			try {
				...
				Path path2 =  Paths.get(INDEX_DIR);
				directory = FSDirectory.open(path2);
